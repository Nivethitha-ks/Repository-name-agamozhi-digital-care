...
const steps = [
  {
    ...
    description: 'We learn about your business, the services you offer, and the customers you want to attract.',
    details: [
      'Fill out our simple consultation form or message us on WhatsApp',
      'Share your trade, key services, and business goals',
      'Choose the website package that fits your needs',
      'Get a clear, honest recommendation and timeline',
    ],
  },
  {
    step: '02',
    name: 'Design',
    icon: Palette,
    title: 'Create the Website Experience & Visual Direction',
    description: 'We organize your pages, content, and photos with a clean layout tailored for your customers.',
    details: [
      'Clear service listings and business details',
      'Clean, readable typography and modern design',
      'Easy-to-find WhatsApp and direct call buttons',
      'Review and agree on layout before building starts',
    ],
  },
  {
    step: '03',
    ...
    description: 'We build your fast, mobile-friendly website with instant WhatsApp chat, call buttons, and contact forms.',
    details: [
      'Fast, modern website development',
      '1-tap WhatsApp chat and phone call buttons',
  ...
  },
  {
    ...
    name: 'Launch',
    icon: Rocket,
    title: 'Test, Deploy & Make the Website Live',
    description: 'We test your website on mobile phones, connect your domain name, and make it live for your customers.',
    details: [
      'Thorough testing on Android and iPhone devices',
      'Search engine ready setup and sitemap generation',
      'Live launch on your custom web address',
      'Handover with dependable ongoing support',
    ],
  },
]
...
const OurProcess = () => {
  useEffect(() => {
    document.title = 'Our Process | Agamozhi Digital Care'
    trackPageView('/our-process')
  }, [])
      ...
      <section className="bg-gradient-to-b from-[#07111F] via-[#0B1F3A] to-[#07111F] text-white py-16 md:py-24 border-b border-slate-800 text-center">
        <div className="container-custom">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-400/20 text-blue-300 text-xs font-bold uppercase tracking-wider mb-4">
            ...
            <span>4-Step Website Process</span>
          </div>
          ...
          <p className="text-slate-200 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
            A simple, transparent four-step process to take your business online quickly and professionally.
          </p>
        </div>
      </section>
